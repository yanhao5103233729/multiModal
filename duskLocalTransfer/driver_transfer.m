...
% 保存匹配图像
imwrite(imgMatch, 'match_image.jpg');
% 保存目标图像
imwrite(imgTarget, 'target_image.jpg');
% 保存输入图像
imwrite(imgInput, 'input_image.jpg');
% 保存输出图像（带局部变换）
imwrite(imgOutput, 'output_image.jpg');
% 保存错误图像
imwrite(imgDiff, 'error_image.jpg');